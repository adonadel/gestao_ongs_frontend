import { AppBar, Toolbar, Typography, Grid, Avatar, Box, Button, Divider } from "@mui/material"
        ...
        <footer style={{
            ...
            <Grid
                ...
                sx={{
                    ...
                    padding: '1rem',
                    boxShadow: '0 -10px 10px 0 #00000025',
                }}
            >
                ...
                <Grid item xs={12} lg={8} sx={{
                    ...
                    >
                        ...
                        >
                            ...
                            <Button size="small" startIcon={<Search color="secondary" />} color="inherit" variant="text" component={Link} sx={styleButton} to="/transparence">
                                Transparência
                            </Button>
                            ...
                            {userData?.role.name === 'admin' && (
                                <Button size="small" startIcon={<Key color="secondary" />} color="inherit" variant="text" component={Link} sx={styleButton} to="/admin">
